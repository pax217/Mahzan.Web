...
exports.selectTotal = exports.selectIds = exports.selectEntities = exports.selectAll = exports.getRoleState = exports.permissionsReducer = exports.initialPermissionsState = exports.adapter = void 0;
// NGRX
...
function permissionsReducer(state, action) {
    ...
    switch (action.type) {
        case permission_actions_1.PermissionActionTypes.AllPermissionsRequested:
            return __assign(__assign({}, state), { _isAllPermissionsLoaded: false });
        case permission_actions_1.PermissionActionTypes.AllPermissionsLoaded:
            return exports.adapter.addAll(action.payload.permissions, __assign(__assign({}, state), { _isAllPermissionsLoaded: true }));
        default:
            return state;
    }
}
