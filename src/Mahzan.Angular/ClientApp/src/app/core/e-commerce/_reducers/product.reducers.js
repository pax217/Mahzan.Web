...
exports.selectTotal = exports.selectIds = exports.selectEntities = exports.selectAll = exports.getProductState = exports.productsReducer = exports.initialProductsState = exports.adapter = void 0;
// NGRX
...
function productsReducer(state, action) {
    ...
    switch (action.type) {
        case product_actions_1.ProductActionTypes.ProductsPageToggleLoading:
            return __assign(__assign({}, state), { listLoading: action.payload.isLoading, lastCreatedProductId: undefined });
        case product_actions_1.ProductActionTypes.ProductsActionToggleLoading:
            return __assign(__assign({}, state), { actionsloading: action.payload.isLoading });
        case product_actions_1.ProductActionTypes.ProductOnServerCreated:
            return __assign({}, state);
        case product_actions_1.ProductActionTypes.ProductCreated:
            return exports.adapter.addOne(action.payload.product, __assign(__assign({}, state), { lastCreatedProductId: action.payload.product.id }));
        case product_actions_1.ProductActionTypes.ProductUpdated:
            return exports.adapter.updateOne(action.payload.partialProduct, state);
        ...
        case product_actions_1.ProductActionTypes.OneProductDeleted:
            return exports.adapter.removeOne(action.payload.id, state);
        case product_actions_1.ProductActionTypes.ManyProductsDeleted:
            return exports.adapter.removeMany(action.payload.ids, state);
        case product_actions_1.ProductActionTypes.ProductsPageCancelled:
        ...
        case product_actions_1.ProductActionTypes.ProductsPageLoaded:
            return exports.adapter.addMany(action.payload.products, __assign(__assign({}, exports.initialProductsState), { totalCount: action.payload.totalCount, listLoading: false, lastQuery: action.payload.page, showInitWaitingMessage: false }));
        default:
            return state;
    }
}
