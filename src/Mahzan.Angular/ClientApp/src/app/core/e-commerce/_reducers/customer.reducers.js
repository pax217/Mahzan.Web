...
exports.selectTotal = exports.selectIds = exports.selectEntities = exports.selectAll = exports.getCustomerState = exports.customersReducer = exports.initialCustomersState = exports.adapter = void 0;
// NGRX
...
function customersReducer(state, action) {
    ...
    switch (action.type) {
        case customer_actions_1.CustomerActionTypes.CustomersPageToggleLoading: {
            return __assign(__assign({}, state), { listLoading: action.payload.isLoading, lastCreatedCustomerId: undefined });
        }
        ...
        case customer_actions_1.CustomerActionTypes.CustomerOnServerCreated:
            return __assign({}, state);
        case customer_actions_1.CustomerActionTypes.CustomerCreated:
            return exports.adapter.addOne(action.payload.customer, __assign(__assign({}, state), { lastCreatedCustomerId: action.payload.customer.id }));
        case customer_actions_1.CustomerActionTypes.CustomerUpdated:
            return exports.adapter.updateOne(action.payload.partialCustomer, state);
        ...
        case customer_actions_1.CustomerActionTypes.OneCustomerDeleted:
            return exports.adapter.removeOne(action.payload.id, state);
        case customer_actions_1.CustomerActionTypes.ManyCustomersDeleted:
        ...
        case customer_actions_1.CustomerActionTypes.CustomersPageLoaded: {
            return exports.adapter.addMany(action.payload.customers, __assign(__assign({}, exports.initialCustomersState), { totalCount: action.payload.totalCount, listLoading: false, lastQuery: action.payload.page, showInitWaitingMessage: false }));
        }
        default:
            return state;
    }
