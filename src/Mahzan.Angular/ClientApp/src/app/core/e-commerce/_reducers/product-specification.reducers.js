...
exports.selectTotal = exports.selectIds = exports.selectEntities = exports.selectAll = exports.getProductSpecificationsState = exports.productSpecificationsReducer = exports.initialProductSpecificationsState = exports.adapter = void 0;
// NGRX
...
function productSpecificationsReducer(state, action) {
    ...
    switch (action.type) {
        case product_specification_actions_1.ProductSpecificationActionTypes.ProductSpecificationsPageToggleLoading:
            return __assign(__assign({}, state), { loading: action.payload.isLoading, lastCreatedProductSpecificationId: undefined });
        ...
        case product_specification_actions_1.ProductSpecificationActionTypes.ProductSpecificationCreated:
            return exports.adapter.addOne(action.payload.productSpecification, __assign(__assign({}, state), { lastCreatedProductSpecificationId: action.payload.productSpecification.id }));
        ...
        case product_specification_actions_1.ProductSpecificationActionTypes.ProductSpecificationsPageCancelled:
            return __assign(__assign({}, state), { totalCount: 0, loading: false, productId: undefined, lastQuery: new crud_1.QueryParamsModel({}) });
        case product_specification_actions_1.ProductSpecificationActionTypes.ProductSpecificationsPageRequested:
            return __assign(__assign({}, state), { totalCount: 0, loading: true, productId: action.payload.productId, lastQuery: action.payload.page });
        case product_specification_actions_1.ProductSpecificationActionTypes.ProductSpecificationsPageLoaded:
            return exports.adapter.addMany(action.payload.productSpecifications, __assign(__assign({}, exports.initialProductSpecificationsState), { totalCount: action.payload.totalCount, loading: false, productId: state.productId, lastQuery: state.lastQuery, showInitWaitingMessage: false }));
        default:
            return state;
    }
}
exports.productSpecificationsReducer = productSpecificationsReducer;
exports.getProductSpecificationsState = store_1.createFeatureSelector('productSpecifications');
