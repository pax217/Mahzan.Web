...
exports.selectTotal = exports.selectIds = exports.selectEntities = exports.selectAll = exports.getProductRemarksState = exports.productRemarksReducer = exports.initialProductRemarksState = exports.adapter = void 0;
// NGRX
...
function productRemarksReducer(state, action) {
    ...
    switch (action.type) {
        case product_remark_actions_1.ProductRemarkActionTypes.ProductRemarksPageToggleLoading:
            return __assign(__assign({}, state), { loading: action.payload.isLoading, lastCreatedProductRemarkId: undefined });
        ...
        case product_remark_actions_1.ProductRemarkActionTypes.ProductRemarkCreated:
            return exports.adapter.addOne(action.payload.productRemark, __assign(__assign({}, state), { lastCreatedProductRemarkId: action.payload.productRemark.id }));
        ...
        case product_remark_actions_1.ProductRemarkActionTypes.ProductRemarksPageLoaded:
            return exports.adapter.addMany(action.payload.productRemarks, __assign(__assign({}, exports.initialProductRemarksState), { totalCount: action.payload.totalCount, loading: false, productId: state.productId, lastQuery: state.lastQuery, showInitWaitingMessage: false }));
        default:
            return state;
    }
}
exports.productRemarksReducer = productRemarksReducer;
exports.getProductRemarksState = store_1.createFeatureSelector('productRemarks');
